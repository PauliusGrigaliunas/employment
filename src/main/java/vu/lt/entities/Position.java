...
public class Position {
    ...
    private List<AbsCandidate> candidatesList = new ArrayList<>();
    ...
    public void addCandidate(AbsCandidate candidate) {
        candidatesList.add(candidate);
        candidate.getPositionsList().add(this);
    }

    public void removeCandidate(AbsCandidate candidate) {
